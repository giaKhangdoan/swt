...
const blogService = {
  ...
  async getBlogs() {
    ...
    const response = await axiosConfig.get(ENDPOINTS.BLOG.LIST, {
      headers: {
  ...
  getBlogById: async (id) => {
    try {
      const response = await axiosConfig.get(ENDPOINTS.BLOG.DETAIL(id));
      return response.data;
    } catch (error) {
  ...
  createBlog: async (blogData) => {
    try {
      ...
      const response = await axiosConfig.post(ENDPOINTS.BLOG.LIST, payload);
      return response.data;
    } catch (error) {
  ...
  updateBlog: async (id, blogData) => {
    try {
      ...
      const response = await axiosConfig.put(ENDPOINTS.BLOG.LIST, payload);
      return response.data;
    } catch (error) {
  ...
  deleteBlog: async (id) => {
    try {
      const response = await axiosConfig.delete(ENDPOINTS.BLOG.DELETE(id));
      return response.data;
    } catch (error) {
  ...
  getBlogPhoto: async (blogId) => {
    try {
      const response = await axiosConfig.get(ENDPOINTS.BLOG.GET_PHOTO(blogId), {
        responseType: 'blob'
      });
